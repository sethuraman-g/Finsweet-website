...
import ButtonSvg from "../../assets/icons/rotateIcon.svg";
          ...
          <Row className="d-flex gap-5">
            <Col md={6}>
              ...
              <ReadMoreButtonComponent
                text="Read More"
                handleClick={openInnerPage}
              />
              <div className="d-flex align-items-center gap-2 my-4">
                <img src={Andrew} alt="Andrew Johnson" />
                <h6>
                  Andrew Jonson
              ...
              <div className="position-relative">
                <img src={Vision} alt="companyVision" width={"100%"} />
                <img
                  src={VerticalLine}
                  alt="VerticalLine"
            ...
            <Col md={4} className="blog-members p-5 position-relative">
              <div>
                ...
                {blogMembers.map((member) => {
                  return (
                    <div className="each-blog" key={member.title}>
                      <div>
                        <h5 className="fw-bold">{member.title}</h5>
                      </div>
                      <div className="d-flex gap-2">
                        <img
                          src={member.blogMember}
                          alt="blogMember"
                          width={"20%"}
                        />
                        <div>
            ...
            <Col md={12}>
              <div className="recent-posts">
                {recentPosts.map((post) => {
                  return (
                    <div className="all-posts d-flex" key={post?.post}>
                      <div>
                        <img
                          src={post.post}
                          alt="posts"
                      ...
                      <div className="each-posts px-4 py-3">
                        <h5 className="fw-bold">{post.postDesc}</h5>
                        <div className="d-flex gap-2">
                          <img src={post.svg} alt="svgPost" />
                      ...
                      <Card className="border-0">
                        ...
                        <Card.Body>
                          ...
                          <div className="d-flex gap-2 align-items-center">
                            <img src={post.person} alt="blogPerson" />
                            <div>
